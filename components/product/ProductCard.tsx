...
export default function ProductCard({ product }: { product: Product }) {
  return (
    <Link
      ...
      className="sport-card group relative block overflow-hidden rounded-2xl border-2 border-neutral-200 bg-white shadow-lg hover:border-orange-500 hover:shadow-2xl dark:border-neutral-800 dark:bg-neutral-900 dark:hover:border-orange-400"
    >
      {/* 图片容器 */}
